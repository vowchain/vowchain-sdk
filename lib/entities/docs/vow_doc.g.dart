...
Map<String, dynamic> _$VowDocToJson(VowDoc instance) {
...
VowDocEncryptionData _$VowDocEncryptionDataFromJson(Map<String, dynamic> json) {
  return VowDocEncryptionData(
    ...
    encryptedData: (json['encrypted_data'] as List<dynamic>)
        .map((e) => _$enumDecode(_$VowEncryptedDataEnumMap, e))
        .toSet(),
  );
}
...
Map<String, dynamic> _$VowDocEncryptionDataToJson(
    ...
    <String, dynamic>{
      ...
      'encrypted_data': instance.encryptedData
          .map((e) => _$VowEncryptedDataEnumMap[e])
          .toList(),
    };

const _$VowEncryptedDataEnumMap = {
  VowEncryptedData.CONTENT: 'content',
  VowEncryptedData.CONTENT_URI: 'content_uri',
  VowEncryptedData.METADATA_CONTENT_URI: 'metadata.content_uri',
  VowEncryptedData.METADATA_SCHEMA_URI: 'metadata.schema.uri',
};
